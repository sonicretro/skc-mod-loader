namespace SKCModManager
{
	partial class NewModDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.checkRedirectSaveFile = new System.Windows.Forms.CheckBox();
			...
			// 
			// checkRedirectSaveFile
			// 
			this.checkRedirectSaveFile.AutoSize = true;
			this.checkRedirectSaveFile.FlatStyle = System.Windows.Forms.FlatStyle.System;
			this.checkRedirectSaveFile.Location = new System.Drawing.Point(6, 156);
			this.checkRedirectSaveFile.Name = "checkRedirectSaveFile";
			this.checkRedirectSaveFile.Size = new System.Drawing.Size(119, 18);
			this.checkRedirectSaveFile.TabIndex = 9;
			this.checkRedirectSaveFile.Text = "Redirect Save File";
			this.checkRedirectSaveFile.UseVisualStyleBackColor = true;
			// 
			// tabControl1
			// 
			...
			this.tabPage1.Controls.Add(this.checkRedirectSaveFile);
        ...
        private System.Windows.Forms.CheckBox checkRedirectSaveFile;
